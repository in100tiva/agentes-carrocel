...
export function useSquadSocket() {
  ...
  const setSquadActive = useSquadStore((s) => (s as any).setSquadActive); // User added this
    ...
    function dispatch(msg: WsMessage) {
      ...
      switch (msg.type) {
        case "SNAPSHOT":
          ...
          break;
        case "SQUAD_ACTIVE":
          if (setSquadActive) setSquadActive((msg as any).squad, (msg as any).state);
          break;
        case "SQUAD_UPDATE":
          updateSquadState((msg as any).squad, (msg as any).state);
          break;
        case "SQUAD_INACTIVE":
          setSquadInactive((msg as any).squad);
          break;
      }
    }
